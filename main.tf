...
module "mongo_clusters" {
  source         = "git::https://github.com/AeternaModules/azurerm_mongo_cluster.git?ref=v4.81.0"
  mongo_clusters = local.mongo_clusters
}

module "mongo_cluster_firewall_rules" {
  source                       = "git::https://github.com/AeternaModules/azurerm_mongo_cluster_firewall_rule.git?ref=v4.81.0"
...
module "mongo_cluster_users" {
  source              = "git::https://github.com/AeternaModules/azurerm_mongo_cluster_user.git?ref=v4.81.0"
